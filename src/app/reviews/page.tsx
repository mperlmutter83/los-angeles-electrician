...
export const metadata: Metadata = {
  title: "Leave a Review | Los Angeles Electrician",
  description: "Leave Los Angeles Electrician a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/CaIiwAFpdWkJEAE/review", kind: "google" },
  { label: "Leave a Yelp Review", href: "https://yelp.com/biz/los-angeles-electrician-san-fernando-valley-2", kind: "yelp" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Los Angeles Electrician and helps us keep improving.
        </p>
